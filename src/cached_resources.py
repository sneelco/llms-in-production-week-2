...
from src.prompt import PROMPT, PROMPT_DYNAMODB
...
#@st.cache_resource
def get_guard_dynamodb() -> gd.Guard:
    """
    Create an output guard using GuardRails.
    """
    return gd.Guard.from_pydantic(output_class=LLMResponseDynamoDB, prompt=PROMPT_DYNAMODB)
